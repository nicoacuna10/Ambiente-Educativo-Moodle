...
@Component({
  selector: 'app-crear-cuenta-administrador',
  templateUrl: './crear-cuenta-administrador.component.html',
  styleUrls: ['./crear-cuenta-administrador.component.scss']
})
export class CrearCuentaAdministradorComponent {
  user!:Usuario;
  ...
  crearCuenta(){
    ...
    this.usuarioService.createAdministrador(this.user).subscribe( res=>{
      this.volver();
