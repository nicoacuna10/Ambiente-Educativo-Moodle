...
@Component({
  selector: 'app-crear-cuenta-apoderado',
  templateUrl: './crear-cuenta-apoderado.component.html',
  styleUrls: ['./crear-cuenta-apoderado.component.scss']
})
export class CrearCuentaApoderadoComponent {
  user!:Usuario;
  apoderado!:Apoderado;
  ...
  crearCuenta(){
    ...
    this.usuarioService.createApoderado(this.formCrearCuenta.value).subscribe( res=>{
      this.volver();
